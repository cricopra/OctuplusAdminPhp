        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                ...
                column = {
                    ...
                    sortableName: (data.sortableName || data.columnId)
                };
            that.columns.push(column);
            if (column.order != null)
            {
                that.sortDictionary[column.sortableName !== null ? column.sortableName : column.id] = column.order;
            }
